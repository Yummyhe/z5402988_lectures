...
#
#In-class Exercise1
#replace values in col2 that are divisible by both 2,3 with -1
import pandas as pd
...
nba_stats = pd.DataFrame(
    {
        ...
        'player' : ['lebron', 'davis', 'kyrie', 'durant', 'harden', 'emniid'],
        'ppg' : [30, 20, 29, 26, 26, 28]
    }
)
